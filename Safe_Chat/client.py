...
model = pickle.load(open("C:/Users/91996/Desktop/ML_Project/ML_Project/Safe_Chat/LinearSVC.pkl", 'rb'))
...
def prettyPrinter(self,data_1):
         # List of stopwords 
    my_file = open("C:/Users/91996/Desktop/ML_Project/ML_Project/Safe_Chat/stopwords.txt", "r")
    content = my_file.read()
    content_list = content.split("\n")
    my_file.close()
    tfidf_vector =  TfidfVectorizer(stop_words = content_list, lowercase = True,vocabulary=pickle.load(open("C:/Users/91996/Desktop/ML_Project/ML_Project/Safe_Chat/tfidf_vector_vocabulary.pkl", "rb")))
...
#     read_socket, write_socket, error_ = select.select(socket_list, [], [])
